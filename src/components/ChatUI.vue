<template>
  ...
  <div class="split-screen organization-selection-container">
    <div class="organization-section-header">Uploaded Files</div>
  ...
  <div class="split-screen chatbot-container">
    <div class="chatbot-header-container">
      <div class="chatbot-header">Upload Any File!</div>
    ...
    <div class="chatbot-body-container">
      ...
      <div class="input-container">
        ...
        <div class="input">
          ...
          <button class="file-btn" @click="onPickFile">Download File</button>
          <input type="file" style="display: none" ref="fileInput"
            accept=".pdf, .txt, .csv, .docx, .pptx, .xlsx, .jpg, .png, .gif, .bmp" @change="onFilePicked" multiple />
...
.input:hover button:hover {
  background-color: rgb(161, 119, 237);
...
.investment-information {
  ...
  align-items: stretch;
  flex: 1;
  /* Add this line to make it grow vertically */
